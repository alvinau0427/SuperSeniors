...
public class InsertEvent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent getinsert = getIntent();
        targetCalendar = getinsert.getStringExtra("targetCalendar");
        targetDay = getinsert.getIntExtra("targetDay", 0);
        targetMonth = getinsert.getIntExtra("targetMonth", 0);
        targetYear = getinsert.getIntExtra("targetYear", 0);
        ...
        insert_event = (Button) findViewById(R.id.insert_event);
        ...
        select_startdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog dialog = new DatePickerDialog(InsertEvent.this,
        ...
        select_starttime.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                picker = new TimePickerDialog(InsertEvent.this,
        ...
        insert_event.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (startYear > endYear || startMonth > endMonth || startDay > endDay || (startDay == endDay && starthour > endhour) ||
                    ...
                    long calendarId = Long.parseLong(targetCalendar);
                    long startMillis = 0;
                    long endMillis = 0;
                    ...
                    int permissionCheck = ContextCompat.checkSelfPermission(InsertEvent.this,
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(InsertEvent.this);
                    builder.setMessage(R.string.event_insert_success)
    ...
    private void timeerror(){
        Toast toast = Toast.makeText(InsertEvent.this, R.string.datetime_error, Toast.LENGTH_LONG);
        toast.show();
    }
